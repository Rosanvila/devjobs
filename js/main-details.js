...
RequirementsItems = (container, data) => {
  const detailsListItem = container.querySelector("#req-list");
...
RoleItems = (container, data) => {
  const detailsRoleItem = container.querySelector(".do-list");
